...
public class DialogsListAdapter<DIALOG extends IDialog>
    ...
    * */
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        private boolean isSame(DIALOG dialog) {
            return TextUtils.equals(dialog.getDialogPhoto(), (dialog.getLastMessage() != null && dialog.getLastMessage().getUser() != null) ? dialog.getLastMessage().getUser().getAvatar() : null);
        }
    }
}
